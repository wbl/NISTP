 ...
 */
#define ECRYPT_NAME "aes-128-gcm"    /* [edit] */ 
#define ECRYPT_PROFILE "bench"    /* [edit] */ 
...
#define ECRYPT_IVSIZE(i) (96 + (i)*64)        /* [edit] */

#define ECRYPT_MAXMACSIZE 128                 /* [edit] */
#define ECRYPT_MACSIZE(i) (128 + (i)*32)       /* [edit] */
...
typedef struct
{
    ...
    u64 padding;
    u32 gfmtable[2048];
} __attribute__ ((aligned (16))) ECRYPT_AE_ctx;
...
#undef ECRYPT_SUPPORTS_AAD                    /* [edit] */
...
#define ECRYPT_BLOCKLENGTH 128                  /* [edit] */
